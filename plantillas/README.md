...
## Nota sobre la utilización de las plantillas:

*** TFG ***

OPCIÓN A: 
- "plantilla TFG vXX.doc" con las fuentes necesarias incrustadas. El archivo es más pesado y puede introducir retardos pesados al auto-guardar periódicamente.Se recomienda la opción B.

OPCIÓN B: 

- "plantilla TFG sinFuentes vXX.doc" sin las fuentes incrustadas. Más ligero, pero requiere de la instalación de las fuentes en el sistema utilizando el fichero siguiente.

- "fuentes Lato Roboto.zip" para instalar las fuentes Lato y Roboto que utiliza la plantilla. Se descomprime este archivo y se copian los ficheros .ttf en el directorio Windows/Fonts


*** TFM ***

- "plantilla TFM.doc". Deben instalarse las fuentes Lato y Roboto (fuentes Lato Roboto.zip) previamente. 
